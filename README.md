...
git clone https://github.com/zarishsphere/zs-svc-appointment.git
cd zs-svc-appointment
...
See [docs.zarishsphere.com/api/zs-svc-appointment](https://docs.zarishsphere.com/api/zs-svc-appointment) for the full OpenAPI 3.1 specification.
